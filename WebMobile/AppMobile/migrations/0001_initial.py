# Generated by Django 4.1.2 on 2022-11-03 16:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, related_name='products', to='AppMobile.tag')),
            ],
            options={
                'ordering': ['name'],
                'unique_together': {('name', 'category')},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('active', models.BooleanField(default=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='AppMobile.product')),
