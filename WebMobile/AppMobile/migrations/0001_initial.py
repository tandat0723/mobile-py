# Generated by Django 4.1 on 2022-10-18 03:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='AppMobile.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('color', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppMobile.color')),
                ('photo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppMobile.photo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppMobile.district')),
                ('province', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppMobile.province')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='AppMobile.product')),
            ],
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=30)),
                ('active', models.BooleanField(default=True)),
                ('memory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppMobile.memory')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='AppMobile.product')),
            ],
        ),
        migrations.AddField(
            model_name='photo',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppMobile.product'),
        ),
        migrations.AddField(
            model_name='district',
            name='province',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='district', to='AppMobile.province'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_detail', to='AppMobile.order')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_detail', to='AppMobile.product')),
            ],
            options={
